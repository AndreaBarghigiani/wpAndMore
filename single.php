						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix single-article'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
								...
								<header class="article-header">
									<a id="thumb-link" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" itemprop="image"><?php the_post_thumbnail( 'wpam-thumb' ); ?></a>
									<h1 class="entry-title single-title" itemprop="headline name">
			                  ...
			                  <p class="byline vcard">
			                  		<span class="author" itemprop="author" itemscope itemtype="http://schema.org/Person">Autore: <strong itemprop="name"><?php echo bones_get_the_author_posts_link(); ?></strong></span>
									...
									<?php
   									...
   									<div id="post-media" class="no480">
   										...
   										<?php endif; if( $presentazione ) : ?> 
   											<div class="link-presentazione">
   												<a href="#presentazione" title="Guarda la presentazione per <?php the_title(); ?>">
   													<?php _e( 'Slide', 'am_theme' ); ?>
   												</a>	
   											</div>
   										<?php endif;
									...
									<?php if( $video ) : ?>
	   								...
	   								<?php endif; ?>
	   								<?php if( $presentazione ) : ?>
		   								<div id="presentazione" class="player">
		   									<?php echo $presentazione; ?>
		   								</div>
	   								<?php endif; ?>
	   								<?php if( $corso ) : ?>
