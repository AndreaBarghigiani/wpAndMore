...
function bones_scripts_and_styles() {
  if (!is_admin()) {
	...
	wp_register_style( 'gloria-font', 'http://fonts.googleapis.com/css?family=Gloria+Hallelujah', array(), '' );
    ...
    wp_register_script( 'bones-js', get_stylesheet_directory_uri() . '/library/js/scripts.js', array( 'jquery' ), '', true );
	 ...
	 //aggiungo lo scripe per gli effetti da caricare nel footer
	 wp_register_script( 'effetti-js', get_stylesheet_directory_uri() . '/library/js/effetti-ck.js', array( 'jquery' ), '', true );
    // enqueue styles and scripts
    wp_enqueue_script( 'bones-modernizr' );
    wp_enqueue_style( 'bones-stylesheet' );
    wp_enqueue_style('bones-ie-only');
	 wp_enqueue_style( 'gloria-font' );
    /*
...
function bones_excerpt_more($more) {
	...
	return ' <strong><em>continua...</em></strong>';
}
